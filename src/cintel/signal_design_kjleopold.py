...
DATA_FILE: Final[Path] = DATA_DIR / "system_metrics_kjleopold.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "signals_kjleopold.csv"
...
def main() -> None:
    ...
    calculated_error_rate: pl.Expr = pl.col("errors").fill_null(0) / pl.col(
        "requests"
    ).fill_null(1)
